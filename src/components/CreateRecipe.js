...
const CreateRecipe = () => {
  // State for selected ingredients, filter visibility, active categories, and search
  ...
  // Close recipe and return to ingredient selection
  const closeRecipe = () => {
          ...
          <div className="how-it-works">
            ...
            <div className="steps">
              ...
              <div className="step">
                ...
                <p>Our smart algorithm will create a unique recipe based on your selected ingredients.</p>
              </div>
